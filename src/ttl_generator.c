...
int main(int argc, char** argv) {
    ...
    fprintf(ttl,
        ...
        "        lv2:minimum 0.0 ;\n"
        "        lv2:maximum 1.0 ;\n"
        "        rdfs:comment \"Maps to MIDI CC 21 (Filter Cutoff)\" ;\n"
        "    ] , [\n"
        "        a lv2:InputPort, lv2:ControlPort ;\n"
        "        lv2:index 6 ;\n"
        ...
        "        lv2:minimum 0.0 ;\n"
        "        lv2:maximum 1.0 ;\n"
        "        rdfs:comment \"Maps to MIDI CC 22 (Filter Resonance)\" ;\n"
        "    ] , [\n"
        "        a lv2:InputPort, lv2:ControlPort ;\n"
        "        lv2:index 7 ;\n"
        "        lv2:symbol \"attack\" ;\n"
        ...
        "        lv2:minimum 0.0 ;\n"
        "        lv2:maximum 1.0 ;\n"
        "        rdfs:comment \"Maps to MIDI CC 23 (Attack Time)\" ;\n"
        "    ] , [\n"
        "        a lv2:InputPort, lv2:ControlPort ;\n"
        "        lv2:index 8 ;\n"
        "        lv2:symbol \"decay\" ;\n"
        ...
        "        lv2:minimum 0.0 ;\n"
        "        lv2:maximum 1.0 ;\n"
        "        rdfs:comment \"Maps to MIDI CC 24 (Decay Time)\" ;\n"
        "    ] , [\n"
        "        a lv2:InputPort, lv2:ControlPort ;\n"
        "        lv2:index 9 ;\n"
        "        lv2:symbol \"sustain\" ;\n"
        ...
        "        lv2:minimum 0.0 ;\n"
        "        lv2:maximum 1.0 ;\n"
        "        rdfs:comment \"Maps to MIDI CC 25 (Sustain Level)\" ;\n"
        "    ] , [\n"
        "        a lv2:InputPort, lv2:ControlPort ;\n"
        "        lv2:index 10 ;\n"
        "        lv2:symbol \"release\" ;\n"
        ...
        "        lv2:minimum 0.0 ;\n"
        "        lv2:maximum 1.0 ;\n"
        "        rdfs:comment \"Maps to MIDI CC 26 (Release Time)\" ;\n"
        "    ] ;\n"
    );
